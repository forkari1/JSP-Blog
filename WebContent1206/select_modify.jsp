...
<body>
	<div align="left">
		<form name="join" method="post" action="modify_process.jsp">
			...
			주소&nbsp;<input type="text" name="address1"	size="20" maxlength="50" class="box" readonly value="<%=address1%>">
			나머지 주소&nbsp; <input type="text" name="address2" size="20" maxlength="50" class="box" value="<%=address2%>"> </br></br>
